...
def generate_report(results, model_results, y_true, y_pred, timestamp, output_dir):
    ...
    for result in results:
        ...
        radius_earth = round(planet_properties.get('radius_earth', 'N/A'), 2)
        orbital_period_days = round(planet_properties.get('orbital_period_days', 'N/A'), 2)
        semi_major_axis_au = round(planet_properties.get('semi_major_axis_au', 'N/A'), 3)
        equilibrium_temp_k = round(planet_properties.get('equilibrium_temp_k', 'N/A'))
