...
# Moved from calibration/utils.py
import bisect
...
def get_calibration_error_uncertainties(probs, labels, p=2, alpha=0.1, mode='marginal'):
    ...
    # [lower, mid, upper] = bootstrap_uncertainty(data, ce_functional, num_samples=100, alpha=alpha) # Removed bootstrap_uncertainty
    # For now, return a dummy value as bootstrap_uncertainty is not moved
    return [0.0, 0.0, 0.0]
